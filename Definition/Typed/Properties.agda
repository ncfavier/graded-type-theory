...
wfEqTerm (app-cong f≡g a≡b p≈p′) = wfEqTerm f≡g
...
subsetTerm (app-subst t⇒u a) = app-cong (subsetTerm t⇒u) (refl a) (Setoid.refl M′)
...
redFirstTerm (β-red {p} A t a PE.refl) = _∘ⱼ_ {q = p} (lamⱼ A t) a
