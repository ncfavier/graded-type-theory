...
mutual
  ...
  stabilityConv↓Term Γ≡Δ (Lift-η k≡k ⊢t₁ ⊢t₂ w₁ w₂ lower≡lower) =
    Lift-η (stabilityConv↑Term Γ≡Δ k≡k) (stabilityTerm Γ≡Δ ⊢t₁) (stabilityTerm Γ≡Δ ⊢t₂) w₁ w₂ (stabilityConv↑Term Γ≡Δ lower≡lower)
