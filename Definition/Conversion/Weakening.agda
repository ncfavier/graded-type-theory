...
mutual
  ...
  wkConv↓Term {ρ} [ρ] (Lift-η a b ⊢t ⊢u wt wu lower≡lower) =
    Lift-η (wkConv↑Term [ρ] a) (wkEqTerm [ρ] b) (wkTerm [ρ] ⊢t) (wkTerm [ρ] ⊢u) (wkWhnf ρ wt) (wkWhnf ρ wu) (wkConv↑Term [ρ] lower≡lower)
