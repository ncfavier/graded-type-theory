...
mutual
  ...
  reflLevel-prop (ne (neNfₜ inc neK k≡k)) = ne (neNfₜ₌ inc neK neK k≡k)
...
private
  ...
  module _ l (reflEq< : <ᵘ-Rec ReflEq l) (reflEqTerm< : <ᵘ-Rec ReflEqTerm l) where
    ...
    reflEqTerm′ (ne′ inc _ D neK K≡K) (neₜ k d (neNfₜ _ neK₁ k≡k)) =
    ...
    reflEq′ (ℕᵣ D) = D
    reflEq′ (Emptyᵣ D) = D
    reflEq′ (Unitᵣ (Unitₜ _ _ _ D _)) = D
    reflEq′ (ne′ inc _ D neK K≡K) =
      ne₌ inc _ D neK K≡K
