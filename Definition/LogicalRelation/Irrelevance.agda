...
mutual
  ...
  reflect-level-prop-cong′ zeroᵘᵣ (ne (neNfₜ () _)) zeroᵘᵣ
  reflect-level-prop-cong′ (ne (neNfₜ () _)) _ zeroᵘᵣ
  reflect-level-prop-cong′ (sucᵘᵣ _) (ne (neNfₜ () _)) (sucᵘᵣ _)
  reflect-level-prop-cong′ (ne (neNfₜ () _)) _ (sucᵘᵣ _)
  reflect-level-prop-cong′ zeroᵘᵣ _ (ne (neNfₜ₌ () _ _))
  reflect-level-prop-cong′ (sucᵘᵣ _) _ (ne (neNfₜ₌ () _ _))
  reflect-level-prop-cong′ (ne _) zeroᵘᵣ (ne (neNfₜ₌ _ () _))
  reflect-level-prop-cong′ (ne _) (sucᵘᵣ _) (ne (neNfₜ₌ _ () _))
  ...
  reflect-level-prop-cong (ne (neNfₜ () _)) (sucᵘᵣ [u]) PE.refl
  reflect-level-prop-cong (ne (neNfₜ () _)) zeroᵘᵣ PE.refl
  reflect-level-prop-cong (sucᵘᵣ [u]) (ne (neNfₜ () _)) PE.refl
  reflect-level-prop-cong zeroᵘᵣ (ne (neNfₜ () _)) PE.refl
